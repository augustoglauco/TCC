...
| **Cliente de modelo externo** | OpenRouter | latest | API compatível com o formato OpenAI, uma única chave cobrindo múltiplos provedores/modelos — chave em `OPENROUTER_API_KEY` (`.env.example`) |
